...
class Opeaning_Text_file(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Opeaning_Text_file")
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'D:\\Semester 3\\EN2130 - Communication Design Project\\Project\\Test Flow Diagrams\\ReceivedText.txt', False)
...
def main(top_block_cls=Opeaning_Text_file, options=None):
