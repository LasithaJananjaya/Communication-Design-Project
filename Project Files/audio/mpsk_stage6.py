...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frame_size=30, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0), puncpat='11'):
        ...
        self.osmosdr_source_0.set_center_freq((0.433e+9), 0)
        ...
        self.osmosdr_sink_0.set_center_freq((0.433e+9), 0)
        ...
        self._noise_volt_range = Range(0, 1, 0.01, 0.4, 200)
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\lenovo\\Desktop\\syncword.txt', True, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\lenovo\\Desktop\\sender.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\lenovo\\Desktop\\receiver.txt', False)
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_throttle_0_2, 0))
        ...
        self.connect((self.blocks_throttle_0_2, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.satellites_sync_to_pdu_packed_0, 0))
        ...
        self.connect((self.fec_extended_decoder_1, 0), (self.blocks_pack_k_bits_bb_0, 0))
        ...
        self.connect((self.pdu_pdu_to_tagged_stream_0, 0), (self.blocks_char_to_float_0_0_0_0, 0))
    ...
    def set_packet_size(self, packet_size):
        ...
        self.satellites_sync_to_pdu_packed_0.set_packlen(self.packet_size)
