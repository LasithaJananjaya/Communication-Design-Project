...
class testing_text1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "testing_text1")
        ...
        self.osmosdr_source_0.set_center_freq(2.4e+9, 0)
        ...
        self.osmosdr_sink_0.set_sample_rate(5e+6)
        self.osmosdr_sink_0.set_center_freq(2.4e+9, 0)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\lenovo\\Desktop\\padded.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\lenovo\\Desktop\\receiver.txt', False)
...
def main(top_block_cls=testing_text1, options=None):
